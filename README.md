...
* Push the branch to your own forked rpository
* Create pull request
* Await commments

A short guide on forking and creating a pull request can be found [here] (https://github.com/xbmc/repo-scripts/CONTRIBUTING.md).
...
The contents of this repository mainly consist of add-on create by thrid party developers. Team Kodi holds no responsibility for it's contents.
